        ...
        <ul class="nav navbar-nav">
            ...
            <li id="CartBlock" class="dropdown notifications-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" title="<?= gettext('Your Cart') ?>">
                    <i class="fa fa-shopping-cart"></i> <!-- this is the "on-hover" function -->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="hidden-xxs">
                <a href="https://github.com/IntelliSOFT-Consulting/kcc" target="_blank" title="<?= gettext('Contributing') ?>">
