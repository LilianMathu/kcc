...
<footer class="main-footer">
    ...
    <strong><?= gettext('Copyright') ?> &copy; <?= SystemService::getCopyrightDate() ?> <a href="http://www.intellisoftkenya.com/" target="_blank"><b>Intellisoft Consulting Limited</b></a>.</strong> <?= gettext('All rights reserved') ?>.
