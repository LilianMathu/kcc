...
class SystemConfig
{
    ...
    private static function buildConfigs()
  {
    return array(
        ...
        "sPhoneFormat" => new ConfigItem(100, "sPhoneFormat", "text", "0712345678"),
        "sPhoneFormatWithExt" => new ConfigItem(101, "sPhoneFormatWithExt", "text", "0712345678"),
        "sPhoneFormatCell" => new ConfigItem(111, "sPhoneFormatCell", "text", "0712345678"),
        ...
        "bEnabledDashboardV2" => new ConfigItem(2073, "bEnabledDashboardV2", "boolean", "0", gettext("Enable New Dashboard")),
        );
  }
  ...
  private static function buildCategories()
  {
    return array (
      ...
      gettext('Enabled Features')  => ["bEnabledFinance", "bEnabledSundaySchool","bEnabledEvents","bEnabledCalendar","bEnabledFundraiser","bEnabledEmail", "bEnabledMenuLinks", "bEnabledDashboardV2"],
